...
# set repo
wget -O /etc/apt/sources.list "http://172.245.223.98/autodebian/debian6/sources.list.debian6"
...
wget -O /etc/nginx/nginx.conf "http://172.245.223.98/autodebian/debian6/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Volcanos VPS  Pin BB : 3227482b  Phone : 085766086968 </pre>" > /home/vps/public_html/index.html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "http://172.245.223.98/autodebian/debian6/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "http://172.245.223.98/autodebian/debian6/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "http://172.245.223.98/autodebian/debian6/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "http://172.245.223.98/autodebian/debian6/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "http://172.245.223.98/autodebian/debian6/1194-client.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://172.245.223.98/autodebian/debian6/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "http://172.245.223.98/autodebian/debian6/badvpn-udpgw64"
fi
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "http://172.245.223.98/autodebian/debian6/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://172.245.223.98/autodebian/debian6/mrtg-mem.sh"
...
curl "http://172.245.223.98/centos/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid/squid.conf "http://172.245.223.98/autodebian/debian6/squid.conf"
sed -i $MYIP2 /etc/squid/squid.conf;
service squid restart

# install webmin
cd
wget "http://172.245.223.98/autodebian/debian6/webmin_1.670_all.deb"
...
wget -O bench-network.sh "http://172.245.223.98/autodebian/debian6/bench-network.sh"
...
curl http://172.245.223.98/debian/volcanos.sh > volcanos.sh
